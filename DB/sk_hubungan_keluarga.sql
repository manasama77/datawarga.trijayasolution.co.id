...
CREATE TABLE `sk_hubungan_keluarga`  (
  ...
  `jenis_relasi` enum('Orang Tua Kandung','Kakek','Nenek','Saudara','Anak','Paman','Bibi','Cucu','Mertua') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
