    ...
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        <form id="form">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" class="form-control" id="lama_domisili" name="lama_domisili" value="<?= $row['lama_domisili']; ?>" placeholder="Lama Domisili" required />
                    <div class="input-group-addon">Tahun</div>
                </div>
            </div>
            <div class="form-group">
                <label for="alamat_domisili">Alamat Domisili <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="alamat_domisili" name="alamat_domisili" value="<?= $row['alamat_domisili']; ?>" placeholder="Alamat Domisili" required />
            </div>
            <hr />
