...
$sql   = "
SELECT  
    belum_mempunyai_rumah.id,
    warga.nama_warga
FROM belum_mempunyai_rumah 
LEFT JOIN warga ON warga.id_warga = belum_mempunyai_rumah.warga_id 
ORDER BY belum_mempunyai_rumah.id DESC
";
...
<div class="row page-header">
    <div class="col-sm-12 col-md-6">
        <h4>
            Peristiwa - Belum Mempunyai Rumah
        </h4>
    </div>
    ...
    <div class="col-12">
        <div class="table-responsive">
            <table id="table_data" class="table table-bordered" style="width: 100%;">
                <caption>Daftar Warga Belum Mempunyai Rumah</caption>
