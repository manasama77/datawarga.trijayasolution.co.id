...
<div class="row page-header">
    <div class="col-sm-12 col-md-6">
        <h4>
            Tambah Data Warga Belum Menikah
        </h4>
    </div>
    ...
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        <form id="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="saksi_2" name="saksi_2" placeholder="Nama Saksi 2" />
            </div>
            <div class="form-group">
                <label for="saksi_3">Nama Saksi 3</label>
                <input type="text" class="form-control" id="saksi_3" name="saksi_3" placeholder="Nama Saksi 3" />
            </div>
            <div class="form-group">
                <hr />
