...
<div class="row">
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        <form id="form">
            ...
            <div class="form-group">
                <label for="warga_id">Warga yang Belum Menikah <span class="text-danger">*</span></label>
            ...
            <hr />
            <h2 class="text-center">Saksi - Saksi</h2>
            <div class="form-group">
                <label for="saksi_1">Nama Saksi 1 <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="saksi_1" name="saksi_1" value="<?= $row['saksi_1']; ?>" placeholder="Nama Saksi 1" required />
            </div>
            <div class="form-group">
                <label for="saksi_2">Nama Saksi 2</label>
                <input type="text" class="form-control" id="saksi_2" name="saksi_2" value="<?= $row['saksi_2']; ?>" placeholder="Nama Saksi 2" />
            </div>
            <div class="form-group">
                <label for="saksi_3">Nama Saksi 3</label>
                <input type="text" class="form-control" id="saksi_3" name="saksi_3" value="<?= $row['saksi_3']; ?>" placeholder="Nama Saksi 3" />
            </div>
            <div class="form-group">
                <hr />
