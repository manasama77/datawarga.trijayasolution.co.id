...
SELECT  
    ...
    warga.nama_warga
FROM tidak_mampu_kesehatan_puskesmas 
LEFT JOIN warga ON warga.id_warga = tidak_mampu_kesehatan_puskesmas.warga_id 
ORDER BY tidak_mampu_kesehatan_puskesmas.id DESC
";
...
<div class="row page-header">
    <div class="col-sm-12 col-md-6">
        <h4>
            Peristiwa - Keterangan Tidak Mampu Untuk Kesehatan (PUSKESMAS)
        </h4>
    </div>
    ...
    <div class="col-12">
        <div class="table-responsive">
            <table id="table_data" class="table table-bordered" style="width: 100%;">
                <caption>Daftar Warga Tidak Mampu Untuk Kesehatan (PUSKESMAS)</caption>
