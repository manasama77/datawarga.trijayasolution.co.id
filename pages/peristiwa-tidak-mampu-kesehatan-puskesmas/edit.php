...
$sql = "
SELECT
	tidak_mampu_kesehatan_puskesmas.id,
...
WHERE
	tidak_mampu_kesehatan_puskesmas.id = " . $_GET['id'] . "
";
...
<div class="row page-header">
    <div class="col-sm-12 col-md-8">
        <h4>
            Edit Data Warga Keterangan Tidak Mampu Untuk Kesehatan (PUSKESMAS)
        </h4>
    </div>
    ...
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        <form id="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_rt_ttd" name="no_rt_ttd" value="<?= $row['no_rt_ttd']; ?>" placeholder="No RT" required />
            </div>
            <div class="form-group">
                <label for="nama_rt_ttd">Nama RT <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_rt_ttd" name="nama_rt_ttd" value="<?= $row['nama_rt_ttd']; ?>" placeholder="Nama RT" required />
            </div>
            <hr />
            <div class="form-group">
                <label for="no_rw_ttd">No RW <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="no_rw_ttd" name="no_rw_ttd" value="<?= $row['no_rw_ttd']; ?>" placeholder="No RW" required />
            </div>
            <div class="form-group">
                <label for="nama_rw_ttd">Nama RW <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_rw_ttd" name="nama_rw_ttd" value="<?= $row['nama_rw_ttd']; ?>" placeholder="Nama RW" required />
            </div>
            <hr />
            <div class="form-group">
                <label for="nama_tksk_ttd">Nama TKSK <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_tksk_ttd" name="nama_tksk_ttd" value="<?= $row['nama_tksk_ttd']; ?>" placeholder="Nama TKSK" required />
            </div>
            <hr />
            <div class="form-group">
