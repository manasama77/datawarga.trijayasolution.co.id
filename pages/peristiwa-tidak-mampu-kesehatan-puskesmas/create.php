...
<div class="row page-header">
    <div class="col-sm-12 col-md-8">
        <h4>
            Tambah Data Warga Keterangan Tidak Mampu Untuk Kesehatan (PUSKESMAS)
        </h4>
    </div>
...
<div class="row">
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        <form id="form">
            ...
            <div class="form-group">
                <label for="no_rt_ttd">No RT <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="no_rt_ttd" name="no_rt_ttd" placeholder="No RT" required />
            </div>
            <div class="form-group">
                <label for="nama_rt_ttd">Nama RT <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_rt_ttd" name="nama_rt_ttd" placeholder="Nama RT" required />
            </div>
            <hr />
            <div class="form-group">
                <label for="no_rw_ttd">No RW <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="no_rw_ttd" name="no_rw_ttd" placeholder="No RW" required />
            </div>
            <div class="form-group">
                <label for="nama_rw_ttd">Nama RW <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_rw_ttd" name="nama_rw_ttd" placeholder="Nama RW" required />
            </div>
            <hr />
            <div class="form-group">
                <label for="nama_tksk_ttd">Nama TKSK <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_tksk_ttd" name="nama_tksk_ttd" placeholder="Nama TKSK" required />
            </div>
            <hr />
            <div class="form-group">
                <label for="nama_ttd">Nama Penandatangan <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nama_ttd" name="nama_ttd" placeholder="Nama" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_register_camat" name="no_register_camat" value="................................................" placeholder="Nomor Register Camat" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nip_camat" name="nip_camat" value="................................................" placeholder="NIP Camat" required />
            </div>
            <div class="form-group">
                <hr />
